...
\begin{itemize}
    ...
    \item Karakter tambahan lainnya:
        \begin{itemize}
        \item \textbf{Debit efektif} (\textit{Specific yield}) atau porositas spesifik (\textit{drainable porosity}}: Nilai jumlah air yang dilepaskan oleh akuifer tak tertekan saat dikeringkan sepenuhnay;
