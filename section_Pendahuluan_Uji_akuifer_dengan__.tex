...
\begin{tabular}{|l|l|}
\hline
Tujuan pengujian                                                   & Disain pengujian yang diperlukan                                                                                     \\ \hline
Untuk menentukan debit pompa optimum                               & Uji sumur tunggal dengan debit bertingkat (Single well step-drawdown test)                                           \\ \hline
Untuk menentukan radius pengaruh dampak pemompaan                  & Uji akuifer dengan berapa sumur pantau (dengan radius ke sumur pemompaan berbeda) dengan debit pemompaan besar.      \\ \hline
Untuk memperkirakan dampak terhadap air permukaan                  & Uji akuifer dengan beberapa sumur pantau dan bendung pada aliran air permukaan.                                      \\ \hline
Karakterisasi akuifer untuk investigasi sistem akuifer secara umum & Uji akuifer dengan waktu pemompaan tambahan pada akuifer yang berbeda-beda dalam radius dekat dengan sumur pemompaan \\ \hline
\end{tabular}%
}
\end{table}
