...
\label{tujuanpengujian}
\begin{tabular}{ll}
Tujuan pengujian                                                   & Disain pengujian yang diperlukan                                                                                     \\
Untuk menentukan debit pompa optimum                               & Uji sumur tunggal dengan debit bertingkat (Single well step-drawdown test)                                           \\
Untuk menentukan radius pengaruh dampak pemompaan                  & Uji akuifer dengan berapa sumur pantau (dengan radius ke sumur pemompaan berbeda) dengan debit pemompaan besar.      \\
